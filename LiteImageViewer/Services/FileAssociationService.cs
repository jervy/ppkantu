...
/// <summary>
/// 文件关联服务 — 使用 HKCU 注册 LiteImageViewer，并尽量把支持的图片扩展名切到本程序。
...
public static class FileAssociationService
{
    ...
    /// <summary>
    /// 是否已经把当前 exe 注册为 LiteImageViewer 的打开命令。
    ...
    /// <summary>
    /// 返回已被 Windows UserChoice 默认应用保护拦截、尚未默认指向 LiteImageViewer 的扩展名。
    /// </summary>
